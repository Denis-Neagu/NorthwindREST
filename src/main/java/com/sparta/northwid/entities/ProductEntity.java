...
public class ProductEntity {
    ...
    private SupplierEntity supplierEntityID;
    ...
    public void setCategoryID(CategoryEntity categoryEntityID) {
        this.categoryEntityID = categoryEntityID;
    }

    public SupplierEntity getSupplierID() {
        return supplierEntityID;
    }

    public void setSupplierID(SupplierEntity supplierEntityID) {
        this.supplierEntityID = supplierEntityID;
    }
